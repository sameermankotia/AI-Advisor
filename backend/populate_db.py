...
with app.app_context():
    ...
    student = Student(
        ...
        email="sameer.mankotia@university.edu",
        major="Computer Science",
        admission_year=2024,
        current_gpa=3.67
    )
    
    # Create all courses from the university schedule with unique codes
    courses = [
        # Fall Term 1 courses
        ...
        Course(course_code="HUMN 1001", course_name="Humanistic and Artistic Ways of Knowing", credits=3, department="General Education", difficulty_rating=2.0, terms_offered="Fall,Spring"),
        ...
        Course(course_code="SCI 2001", course_name="Science with Lab Course", credits=4, department="Science", difficulty_rating=3.0, terms_offered="Fall,Spring"),
        Course(course_code="ELEC 2001", course_name="Elective Course", credits=1, department="General Education", difficulty_rating=2.0, terms_offered="Fall,Spring,Summer"),
        ...
        Course(course_code="STAT 2010", course_name="Statistical Methods", credits=3, department="Statistics", difficulty_rating=3.5, terms_offered="Fall,Spring"),
        ...
        Course(course_code="CS 4001", course_name="Technical Elective - CS/Cybersecurity", credits=3, department="Computer Science", difficulty_rating=4.0, terms_offered="Fall,Spring"),
        Course(course_code="SOCL 3001", course_name="Social and Behavioral Ways of Knowing", credits=3, department="General Education", difficulty_rating=2.0, terms_offered="Fall,Spring"),
        
        # Spring Term 3 courses
        ...
        Course(course_code="CS 3186", course_name="Analysis of Algorithms", credits=3, department="Computer Science", difficulty_rating=4.5, terms_offered="Fall,Spring"),
        ...
        Course(course_code="AMER 3001", course_name="American Experience", credits=3, department="General Education", difficulty_rating=2.0, terms_offered="Fall,Spring"),
        ...
        Course(course_code="INTL 3001", course_name="International Course", credits=3, department="General Education", difficulty_rating=2.0, terms_offered="Fall,Spring"),
    ]
